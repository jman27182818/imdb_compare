...
show1 = raw_input("what is the first show title: ")
show2 = raw_input("what is the second show title: ")
...
queryhtmldata1 = urllib2.urlopen(query1).read()
queryhtmldata2 = urllib2.urlopen(query2).read()

q = re.compile('="/title/tt[0-9]+?/')
ids1 = q.findall(queryhtmldata1)
ids2 = q.findall(queryhtmldata2)
...
actors1 = p.findall(htmldata1)
actors2 = p.findall(htmldata2)
